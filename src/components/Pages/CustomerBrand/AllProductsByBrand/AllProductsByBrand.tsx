import styles from "./AllProductsByBrand.module.css";
...
export default function AllProductsByBrand() {
  ...
  const searchHandler = (searchString: string) => {
    ...
    getAllProductsByBrand(0, pageSize, sortBy, sortDir, keyword, brand)
      .then((result: any) => {
