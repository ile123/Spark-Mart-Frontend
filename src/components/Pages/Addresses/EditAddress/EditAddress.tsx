...
export default function EditUser() {
    ...
    const { state: { userId, addressId } } = useLocation();
                ...
                <Card.Body>
                    <div className={styles.grid}>
                        <div className={styles.item}>
                            ...
                            <input type="text" className={styles.input} defaultValue={address?.streetAddress} {...register("streetAddress", { 
                                required: {
                                    value: true,
                        ...
                        <div className={styles.item}>
                            ...
                            <input type="text" className={styles.input} defaultValue={address?.city} {...register("city", { 
                                required: {
                                    value: true,
                    ...
                    <div className={styles.grid}>
                        <div className={styles.item}>
                            ...
                            <input type="text" className={styles.input} defaultValue={address?.postalCode} {...register("postalCode", { 
                                required: {
                                    value: true,
                        ...
                        <div className={styles.item}>
                        <h3 className={styles.label}>Postal Code: </h3>
                            <input type="text" className={styles.input} defaultValue={address?.province} {...register("province", { 
                                required: {
                                    value: true,
                    ...
                    <div className={styles.grid}>
                        <div className={styles.item}>
                        <h3>Country: </h3>
                        <input type="text" className={styles.input} defaultValue={address?.country} {...register("country", { 
                                required: {
                                    value: true,
