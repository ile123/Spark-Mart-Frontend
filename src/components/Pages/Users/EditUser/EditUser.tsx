                ...
                <Card.Body>
                    <div className={styles.grid}>
                        <div className={styles.item}>
                            ...
                            <input type="text" className={styles.input} defaultValue={user?.firstName} {...register("firstName", { 
                                required: {
                                    value: true,
                        ...
                        <div className={styles.item}>
                            ...
                            <input type="text" className={styles.input} defaultValue={user?.lastName} {...register("lastName", { 
                                required: {
                                    value: true,
                    ...
                    <div className={styles.grid}>
                        <div className={styles.item}>
                            ...
                            <input type="text" className={styles.input} defaultValue={user?.phoneNumber} {...register("phoneNumber", { 
                                required: {
                                    value: true,
                ...
                <Card.Footer id={styles.footer}>
                    <div className={styles.grid}>
                        <div className={styles.footerItem}>
                            <Link to="/changePassword" id={styles.changePassword} state={ {userId: userId} }>Change Password</Link>
                        </div>
                        <div className={styles.footerItem}>
